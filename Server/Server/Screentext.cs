...
//Wraps XNA's text rendering functions in a easy to use interface
class ScreenText
{
    ...
    {
        batch.Begin();
        batch.DrawString(Font, TextContent, Position + new Vector2(1, 1), Color.Black, 0, new Vector2(0, 0), ScreenTextManager.TextRenderScale, SpriteEffects.None, 0);
        batch.DrawString(Font, TextContent, Position, TextColour, 0, new Vector2(0, 0), ScreenTextManager.TextRenderScale, SpriteEffects.None, 0);
        batch.End();
    }
}
static class ScreenTextManager
{
    public static float TextRenderScale = 1.5f;
